...
export type CreateSchoolYearRequest = Schemas["CreateSchoolYearRequest"]
export type PagedResponseOfSchoolYearResponse = Schemas["PagedResponseOfSchoolYearResponse"]
